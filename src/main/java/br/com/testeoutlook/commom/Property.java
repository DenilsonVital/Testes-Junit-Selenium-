...
public abstract class Property {
	...
	private static final String PROPERTIES_FILE = "br/com/testeOutlook/config.properties";
	...
	static {
		...
		//IE64_DRIVE_PATH = new File ("").getAbsoluteFile()+"\\src\\main\\resources\\IEDriverServer.exe";
